...
DEFINE_string(precision, "fp16", "Precision be one of fp32/fp16/int8");
...
// detection related
DEFINE_string(det_model_dir, "./inference/det_infer", "Path of det inference model.");
...
DEFINE_double(det_db_unclip_ratio, 1.8, "Threshold of det_db_unclip_ratio.");
DEFINE_bool(use_dilation, false, "Whether use the dilation on output map.");
DEFINE_string(det_db_score_mode, "fast", "Whether use polygon score.");
DEFINE_bool(visualize, true, "Whether show the detection results.");
// classification related
DEFINE_bool(use_angle_cls, true, "Whether use use_angle_cls.");
DEFINE_string(cls_model_dir, "./inference/cls_infer", "Path of cls inference model.");
DEFINE_double(cls_thresh, 0.9, "Threshold of cls_thresh.");
DEFINE_int32(cls_batch_num, 1, "cls_batch_num.");
// recognition related
DEFINE_string(rec_model_dir, "./inference/rec_infer", "Path of rec inference model.");
...
DEFINE_bool(cls, true, "Whether use cls in forward.");
